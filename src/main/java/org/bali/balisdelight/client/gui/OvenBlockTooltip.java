...
public class OvenBlockTooltip implements ClientTooltipComponent {
    ...
    public OvenBlockTooltip(CookingPotTooltipComponent tooltip) {
    ...
    public int getWidth(Font font) {
        if (!mealStack.isEmpty()) {
            ...
            return font.width(TextUtils.getTranslation("tooltip.oven.empty"));
        }
    }
